        ...
        <div style="margin-left: 97%;;">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" action="<?php echo site_url('c_mavericks/createActionTU') ?>"method="post">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control"id="jumlah_kasus_tu" name="jumlah_kasus_tu">
                </div>
                <div class="col-md-6">
                <label for="inputCity" class="form-label">Tingkat Usia</label>
                    <select class="form-select" id="id_tingkat" name="id_tingkat">
